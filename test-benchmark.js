...
test("benchmark", t => {
    ...
    mt1 = microtime.now();
    for (let i = 0; i < iteration; i++)
        s.iterateValues(alive, () => {});
    logtime("iterateValues alive on", mt1, microtime.now(), entityCount, iteration);
    ...
    for (let i = 0; i < iteration; i++)
        s.iterateValues(alive, () => {});
    logtime("iterateValues alive off", mt1, microtime.now(), entityCount, iteration);
